  ...
  return (
    <div id="Home" className="aligncenter container my-0 row mx-auto mt-5 ">
      <div className="col-md-6 col-sm-12">
        <img
          data-aos={"flip-right"}
          src="./images/vectors/bear-symbol.png"
          alt="The Bear"
          className="img-fluid flip-in-y hero-bear img-visibility App-logo"
        />
      </div>
      <div className="col-md-6 col-sm-12 aboutInfo">
        <h1
          className="text-center main-title mt-3 text-uppercase font-integral"
          data-aos="fade-up"
        >
          Swaga Bears
        </h1>
        <h3 className="text-center font-integral">
          Mint Date:
          <span
            className="text-primary font-integral"
            style={{ textOverflow: "initial" }}
          >
            20.04 / 17:00 GMT
            <a className="btn btn-primary mt-4 mr-sm-4 mb-3 mb-sm-0" href="#">
              <svg
